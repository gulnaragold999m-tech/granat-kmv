...
ADDONS_NOVYE = {
    ...
    "hard_pack": ("Подарочное оформление: конверт или коробка, знак студии", 150, "per_order"),
}
...
DOSTAVKA_KAK_SCHITAEM = "Везёт служба доставки или такси — сумму называет она, и зависит она от адреса и часа. Посчитаем и скажем точную цену перед отправкой, до этого угадывать не будем."
