...
1. «Как удобно получить заказ?», options: ["Заберу сам в Лермонтове",
   ...
   - По КМВ — спроси город и скажи: везём Яндекс Доставкой, по тарифу
     сервиса. Точную сумму назовём при подтверждении — она считается
     по адресу и размеру посылки. НЕ выдумывай цифру.
     Формулировка «Яндекс Доставка» названа владелицей 20.08.2026
     вместо прежней «по тарифу такси»: сервис знакомый, с трекингом,
     и звучит как нормальная услуга, а не как одолжение.
