...
1. «Как удобно получить заказ?», options: ["Заберу сам в Лермонтове",
   "Доставка по Лермонтову", "Доставка по КМВ"].
   - Самовывоз — бесплатно, адрес и часы назови.
   - По Лермонтову — цена из DOPUSLUGI["delivery"] в ceny_iz_prajsa.py.
     От суммы DOSTAVKA_BESPLATNO_OT — бесплатно, так и скажи.
