...
<section class="vopros">
  ...
  <ol>
    ...
    <li><b>Бумага.</b> До 200 г/м² — распечатка. От 250 г/м² картон — считается как открытка.</li>
...
<section>
  <h2>Открытки, сертификаты, дипломы · картон 300–350 г/м²</h2>
  ${tablica(OTKRYTKI)}
  <div class="note">
    <span class="big">Штучно А4 — 200 ₽/шт, заказ от 1200 ₽.</span><br>
    Сертификат, диплом, грамота на картоне — это ЭТА таблица, а не распечатка за 35 ₽.
  </div>
</section>
