...
GREETING = (
    ...
    "техническое задание.\n\n"
    "Для заявки мне понадобится ваше имя и то, как с вами связаться. "
    "Продолжая, вы даёте согласие на обработку этих данных — они нужны "
    "только менеджеру студии для связи по заказу."
)
