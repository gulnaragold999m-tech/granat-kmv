...
# Оба телефона владелицы: рабочий студии и второй личный. Второй
# добавлен 22.08.2026 — проверка секретаря с него ушла как настоящая
# заявка и потратила номер, потому что сервер его не знал.
TEST_PHONES = {"79992449999", "79283528999"}
